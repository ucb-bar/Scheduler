# Automatic co-design loop — `_flight_deployed_2frame`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/_flight_deployed_2frame.json --max-rounds 3
```

**Baseline → final: 56.6 → 42.4 ms (-25.1%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 56.6 | 42.4 | -25.1 | 0 |
