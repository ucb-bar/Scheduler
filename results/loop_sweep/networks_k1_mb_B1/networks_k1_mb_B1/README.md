# Automatic co-design loop — `networks_k1_mb_B1`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/networks_k1_mb_B1.json --max-rounds 3
```

**Baseline → final: 310.1 → 310.1 ms (-0.0%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 310.1 | 310.1 | -0.0 | 0 |
