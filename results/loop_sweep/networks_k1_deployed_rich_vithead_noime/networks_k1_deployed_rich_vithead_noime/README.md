# Automatic co-design loop — `networks_k1_deployed_rich_vithead_noime`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/networks_k1_deployed_rich_vithead_noime.json --max-rounds 3
```

**Baseline → final: 122.6 → 110.1 ms (-10.2%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 122.6 | 110.1 | -10.2 | 0 |
