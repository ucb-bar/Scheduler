# Automatic co-design loop — `networks_k1_deployed_rich_vithead`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/networks_k1_deployed_rich_vithead.json --max-rounds 3
```
