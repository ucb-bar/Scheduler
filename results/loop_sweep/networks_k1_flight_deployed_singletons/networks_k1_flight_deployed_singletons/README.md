# Automatic co-design loop — `networks_k1_flight_deployed_singletons`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/networks_k1_flight_deployed_singletons.json --max-rounds 3
```
