# Automatic co-design loop — `s5_solvable_reveal`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/scaling/s5_solvable_reveal.json --max-rounds 3
```

**Baseline → final: 51.6 → 33.1 ms (-35.9%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 51.6 | 33.1 | -35.9 | 0 |
| 2 | _(none accepted)_ | 33.091 | — | — | — |
