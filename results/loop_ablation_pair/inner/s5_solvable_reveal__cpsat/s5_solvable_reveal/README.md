...
```
scripts/run_codesign_loop.py --workload data/toplevel/scaling/s5_solvable_reveal.json --max-rounds 4
```

**Baseline → final: 51.6 → 39.6 ms (-23.3%)** — levers applied: ['ime'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +ime | 51.6 | 39.6 | -23.3 | 0 |
| 2 | _(none accepted)_ | 39.601 | — | — | — |
