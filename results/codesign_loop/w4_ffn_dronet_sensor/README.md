...
```
scripts/run_codesign_loop.py --workload /scratch/agustin/xpurt-dev-sync/data/toplevel/scaling/w4_ffn_dronet_sensor.json --max-rounds 4
```

**Baseline → final: 74.6 → 62.7 ms (-7.7%)** — levers applied: ['ime'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +ime | 74.6 | 69.4 | -7.7 | 22 |
| 2 | _(none accepted)_ | 642.003 | — | — | — |
