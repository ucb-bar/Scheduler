...
```
scripts/run_codesign_loop.py --workload /scratch/agustin/xpurt-dev-sync/data/toplevel/scaling/w5_ffn_dronet_yolo.json --max-rounds 4
```

**Baseline → final: 74.6 → 88.9 ms (-12.8%)** — levers applied: ['ime'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +ime | 74.6 | 79.6 | -12.8 | 23 |
| 2 | _(none accepted)_ | 726.54 | — | — | — |
