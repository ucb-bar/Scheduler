# Automatic co-design loop — `networks_k1_ffn_ime`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/networks_k1_ffn_ime.json --max-rounds 3
```

**Baseline → final: 150.1 → 150.1 ms (-0.0%)** — levers applied: ['ime', 'shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +ime | 150.1 | 150.1 | -0.0 | 0 |
| 2 | +shard | 150.1 | 150.1 | -0.0 | 0 |
