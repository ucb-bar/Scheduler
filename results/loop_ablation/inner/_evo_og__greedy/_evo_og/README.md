# Automatic co-design loop — `_evo_og`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/_evo_og.json --max-rounds 3
```

**Baseline → final: 898.1 → 847.9 ms (-5.6%)** — levers applied: ['unfuse', 'ime'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +unfuse | 898.1 | 866.4 | -3.5 | 0 |
| 2 | +ime | 866.4 | 847.9 | -2.1 | 0 |
