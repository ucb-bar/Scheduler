# Automatic co-design loop — `networks_k1_sensor_sharded_rich`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/networks_k1_sensor_sharded_rich.json --max-rounds 3
```

**Baseline → final: 126.6 → 107.9 ms (-14.8%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 126.6 | 107.9 | -14.8 | 0 |
