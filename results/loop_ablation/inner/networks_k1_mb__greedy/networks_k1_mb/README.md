# Automatic co-design loop — `networks_k1_mb`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/networks_k1_mb.json --max-rounds 3
```

**Baseline → final: 8.0 → 4.9 ms (-39.2%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 8.0 | 4.9 | -39.2 | 0 |
