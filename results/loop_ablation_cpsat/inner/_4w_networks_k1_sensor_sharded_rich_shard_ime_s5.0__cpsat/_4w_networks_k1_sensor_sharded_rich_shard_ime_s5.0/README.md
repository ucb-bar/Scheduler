# Automatic co-design loop — `_4w_networks_k1_sensor_sharded_rich_shard_ime_s5.0`
...
```
scripts/run_codesign_loop.py --workload data/toplevel/_4w_networks_k1_sensor_sharded_rich_shard_ime_s5.0.json --max-rounds 3
```

**Baseline → final: 46.6 → 32.7 ms (-29.9%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 46.6 | 32.7 | -29.9 | 1 |
