...
```
scripts/run_codesign_loop.py --workload data/toplevel/_4w_networks_k1_sensor_sharded_rich_shard_ime_s4.0.json --max-rounds 3
```

**Baseline → final: 56.2 → 32.9 ms (-41.5%)** — levers applied: ['shard'].

| round | lever | before (ms) | after (ms) | % | misses |
|--:|--|--:|--:|--:|--:|
| 1 | +shard | 56.2 | 32.9 | -41.5 | 0 |
